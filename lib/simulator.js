...
var upload = function (simulator, graph, callback) {
    ...
    // TODO: use runtime communication
...
function RuntimeSimulator() {
    ...
    this.runtimeComm = new runtime.RuntimeCommunication(this.transport);
    ...
    // Input/Output
    this.send = function(obj, portName) {
        var toplevelNode = 1;
        var portId = 0;

        self.runtimeComm.sendPacket(...);
    }
